...
Production-ready configuration for Recipe Management and Meal Planning App.
"""
...
if USE_S3:
    ...
    DEFAULT_FILE_STORAGE = 'mealmate.storage_backends.PublicMediaStorage'
...
SITE_ID = 1
# New format for Django Allauth 65+
